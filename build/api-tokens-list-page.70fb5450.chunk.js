"use strict";
(self["webpackChunke_commerce"] = self["webpackChunke_commerce"] || []).push([[8056],{
...
const LinkStyled = (0,styled_components_browser_cjs["default"])(build.Link)`
  svg {
    path {
...
const UpdateButton = ({ tokenName, tokenId }) => {
  return /* @__PURE__ */ react.createElement(DynamicTable_DefaultButton, {
    tokenName,
    tokenId
...
const TableRows = ({ canDelete, canUpdate, canRead, onClickDelete, withBulkActions, rows }) => {
  ...
  return /* @__PURE__ */ react.createElement(Table.Tbody, null, apiTokens.map((apiToken) => {
    return /* @__PURE__ */ react.createElement(Table.Tr, DynamicTable_spreadValues({
    ...
    }))), /* @__PURE__ */ react.createElement(Table.Td, null, apiToken.lastUsedAt && /* @__PURE__ */ react.createElement(Typography.Typography, {
      textColor: "neutral800"
    }, /* @__PURE__ */ react.createElement(build.RelativeTime, {
      timestamp: new Date(apiToken.lastUsedAt)
      ...
      tokenId: apiToken.id
    }), !canUpdate && canRead && /* @__PURE__ */ react.createElement(DynamicTable_ReadButton, {
      tokenName: apiToken.name,
      tokenId: apiToken.id
