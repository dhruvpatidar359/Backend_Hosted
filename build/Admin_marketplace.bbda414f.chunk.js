(self["webpackChunke_commerce"] = self["webpackChunke_commerce"] || []).push([[5516],{
...
// EXTERNAL MODULE: ./node_modules/@strapi/icons/Upload.js
var Upload = __webpack_require__(82036);
...
// EXTERNAL MODULE: ./node_modules/@strapi/icons/GlassesSquare.js
var GlassesSquare = __webpack_require__(60596);
...
const TooltipButton = ({ description, installMessage, disabled, handleCopy, pluginName }) => /* @__PURE__ */ react.createElement(Tooltip.Tooltip, {
  "data-testid": `tooltip-${pluginName}`,
  description
}, /* @__PURE__ */ react.createElement(Box.Box, null, /* @__PURE__ */ react.createElement(Button.Button, {
  size: "S",
...
const CardButton = ({ strapiPeerDepVersion, strapiAppVersion, handleCopy, pluginName }) => {
  ...
  if (strapiAppVersion) {
    if (!versionRange) {
      return /* @__PURE__ */ react.createElement(TooltipButton, {
        installMessage,
        pluginName,
...
const InstallPluginButton = ({
  ...
  if (isInDevelopmentMode) {
    return /* @__PURE__ */ react.createElement(NpmPackageCard_CardButton, {
      strapiAppVersion,
      strapiPeerDepVersion,
      handleCopy,
      pluginName
...
const MarketPlacePage = () => {
  ...
  const { status: marketplacePluginsStatus, data: marketplacePluginsResponse } = hooks_useFetchMarketplacePlugins(notifyMarketplaceLoad);
  const { status: marketplaceProvidersStatus, data: marketplaceProvidersResponse } = hooks_useFetchMarketplaceProviders(notifyMarketplaceLoad);
