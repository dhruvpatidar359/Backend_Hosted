...
// EXTERNAL MODULE: ./node_modules/@strapi/icons/Envelop.js
var Envelop = __webpack_require__(78086);
...
const TableRows = ({
  ...
  return /* @__PURE__ */ react.createElement(Table.Tbody, null, rows.map((data) => {
    const isChecked = entriesToDelete.findIndex((id) => id === data.id) !== -1;
    return /* @__PURE__ */ react.createElement(Table.Tr, __spreadValues({
      key: data.id
    }, (0,build.onRowClick)({
      fn: () => push(`${pathname}/${data.id}`),
      condition: withBulkActions
    })), withMainAction && /* @__PURE__ */ react.createElement(Table.Td, __spreadValues({}, build.stopPropagation), /* @__PURE__ */ react.createElement(BaseCheckbox.BaseCheckbox, {
      ...
      return /* @__PURE__ */ react.createElement(Table.Td, {
        key
      }, typeof cellFormatter === "function" ? cellFormatter(data, __spreadValues({ key, name, formatMessage }, rest)) : /* @__PURE__ */ react.createElement(Typography.Typography, {
    ...
    }), canDelete && /* @__PURE__ */ react.createElement(Box.Box, __spreadValues({
      paddingLeft: 1
...
const tableHeaders = [
  ...
  },
  {
    ...
    cellFormatter({ isActive }, { formatMessage }) {
      return /* @__PURE__ */ react.createElement(Flex.Flex, null, /* @__PURE__ */ react.createElement(build.Status, {
        isActive,
...
const ListPage = () => {
  ...
  const createAction = canCreate ? /* @__PURE__ */ react.createElement(Button.Button, {
  ...
  return /* @__PURE__ */ react.createElement(Main.Main, {
    ...
    startActions: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(build.SearchURLQuery, {
      label: formatMessage(
        { id: "app.component.search.label", defaultMessage: "Search for {target}" },
        { target: title }
      )
    }), /* @__PURE__ */ react.createElement(ListPage_Filters, {
      displayedFilters: utils_displayedFilters
    }))
  }), /* @__PURE__ */ react.createElement(Layout.ContentLayout, {
    canRead
  }, !canRead && /* @__PURE__ */ react.createElement(build.NoPermissions, null), status === "error" && /* @__PURE__ */ react.createElement("div", null, "TODO: An error occurred"), canRead && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(build.DynamicTable, {
    contentType: "Users",
    isLoading,
  ...
  }))), isModalOpened && /* @__PURE__ */ react.createElement(ListPage_ModalForm, {
    onToggle: handleToggle,
    queryName
  }));
};
...
}, /* @__PURE__ */ react.createElement(Users_ListPage, null));
...
/* harmony import */ var _strapi_design_system_IconButton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30741);
...
/* harmony import */ var _strapi_icons_Duplicate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(67483);
...
/* harmony import */ var _strapi_design_system_Select__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(43808);
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(16384);
/* harmony import */ var _strapi_icons_Loader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(57572);
