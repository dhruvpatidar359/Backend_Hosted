(self["webpackChunke_commerce"] = self["webpackChunke_commerce"] || []).push([[5905],{
...
function List({
  ...
  return /* @__PURE__ */ react.createElement(List_BoxWrapper, null, /* @__PURE__ */ react.createElement(Box.Box, List_spreadValues({
    paddingLeft: 6,
...
// EXTERNAL MODULE: ./node_modules/@strapi/icons/Lock.js
var Lock = __webpack_require__(51347);
...
const DisplayedType = ({ type, customField, repeatable }) => {
  ...
  if (customField) {
    return /* @__PURE__ */ react.createElement(Typography.Typography, null, formatMessage({
...
function ListRow({
  ...
  return /* @__PURE__ */ react.createElement(ListRow_BoxWrapper, ListRow_spreadValues({
    ...
    defaultMessage: "from"
  })}: ${isPluginContentType})`)) : /* @__PURE__ */ react.createElement(ListRow_DisplayedType, {
    type,
    customField,
    repeatable
