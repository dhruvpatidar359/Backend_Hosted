"use strict";
(self["webpackChunke_commerce"] = self["webpackChunke_commerce"] || []).push([[7375],{
...
const Regenerate = ({ onRegenerate, idToRegenerate }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Button.Button, {
    startIcon: /* @__PURE__ */ react.createElement((Refresh_default()), null),
    type: "button",
    size: "S",
    variant: "tertiary",
    ...
    iconRightButton: /* @__PURE__ */ react.createElement((Refresh_default()), null),
...
const FormHead = ({ apiToken, setApiToken, canEditInputs, canRegenerate, isSubmitting }) => {
  ...
  return /* @__PURE__ */ react.createElement(Layout.HeaderLayout, {
    ...
    primaryAction: canEditInputs ? /* @__PURE__ */ react.createElement(Stack.Stack, {
      horizontal: true,
      spacing: 2
    }, canRegenerate && (apiToken == null ? void 0 : apiToken.id) && /* @__PURE__ */ react.createElement(components_Regenerate, {
      onRegenerate: handleRegenerate,
      idToRegenerate: apiToken == null ? void 0 : apiToken.id
...
FormHead.propTypes = {
  apiToken: prop_types_default().shape({
    ...
    lifespan: (prop_types_default()).number,
...
// EXTERNAL MODULE: ./node_modules/@strapi/icons/Key.js
var Key = __webpack_require__(69666);
...
const ApiTokenPermissionsContextProvider = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(ApiTokenPermissionsContext.Provider, {
    value: rest
  }, children);
};
...
const CollapsableContentType = ({
  ...
  return /* @__PURE__ */ react.createElement(Accordion.Accordion, {
    ...
    title: (0,lodash.capitalize)(label)
  }), /* @__PURE__ */ react.createElement(Accordion.AccordionContent, null, controllers == null ? void 0 : controllers.map((controller) => {
    ...
    return /* @__PURE__ */ react.createElement(Box.Box, {
      key: `${label}.${controller == null ? void 0 : controller.controller}`
      ...
      variant: "sigma",
      textColor: "neutral600"
    }, controller == null ? void 0 : controller.controller)), /* @__PURE__ */ react.createElement(Border, null), /* @__PURE__ */ react.createElement(Box.Box, {
      paddingLeft: 4
      ...
      disabled
    }, "Select all"))), /* @__PURE__ */ react.createElement(Grid.Grid, {
      gap: 4,
      padding: 4
    }, (controller == null ? void 0 : controller.actions) && (controller == null ? void 0 : controller.actions.map((action) => {
...
const ContentTypesSection = (_a) => {
  ...
  return /* @__PURE__ */ react.createElement(Box.Box, {
    padding: 4,
    background: "neutral0"
  }, section && section.map((api, index) => /* @__PURE__ */ react.createElement(components_CollapsableContentType, ContenTypesSection_spreadValues({
    key: api.apiId,
    label: api.label,
...
const ActionBoundRoutes = () => {
  ...
  return /* @__PURE__ */ react.createElement(Grid.GridItem, {
    ...
    spacing: 2
  }, (_a = routes[actionSection]) == null ? void 0 : _a.map((route) => {
    var _a2, _b;
    return ((_b = (_a2 = route.config.auth) == null ? void 0 : _a2.scope) == null ? void 0 : _b.includes(selectedAction)) || route.handler === selectedAction ? /* @__PURE__ */ react.createElement(components_BoundRoute, {
      key: route.handler,
      route
    }) : null;
  })) : /* @__PURE__ */ react.createElement(Stack.Stack, {
...
const Permissions = (_a) => {
  ...
  }))), (data == null ? void 0 : data.permissions) && /* @__PURE__ */ react.createElement(ContenTypesSection, Permissions_spreadValues({
    section: data == null ? void 0 : data.permissions
  }, props))), /* @__PURE__ */ react.createElement(components_ActionBoundRoutes, null));
};
...
const FormBody = ({
  ...
  return /* @__PURE__ */ react.createElement(Layout.ContentLayout, null, /* @__PURE__ */ react.createElement(Stack.Stack, {
    spacing: 6
  }, Boolean(apiToken == null ? void 0 : apiToken.name) && /* @__PURE__ */ react.createElement(ContentBox, {
    apiToken: apiToken == null ? void 0 : apiToken.accessKey
  }), /* @__PURE__ */ react.createElement(components_FormApiTokenContainer, {
    errors,
    onChange,
    canEditInputs,
    isCreating,
    ...
    onDispatch,
    setHasChangedPermissions
  }), /* @__PURE__ */ react.createElement(components_Permissions, {
...
const ApiTokenCreateView = () => {
  ...
  const handleSubmit = (body, actions) => EditView_async(void 0, null, function* () {
    ...
    try {
      ...
      if (((_c = (_b = (_a2 = err == null ? void 0 : err.response) == null ? void 0 : _a2.data) == null ? void 0 : _b.error) == null ? void 0 : _c.message) === MSG_ERROR_NAME_TAKEN) {
        toggleNotification({
          type: "warning",
          message: (0,lodash.get)(err, "response.data.message", "notification.error.tokennamenotunique")
        });
      } else {
        toggleNotification({
          type: "warning",
          message: (0,lodash.get)(err, "response.data.message", "notification.error")
        });
      }
      unlockApp();
    }
  ...
  return /* @__PURE__ */ react.createElement(ApiTokenPermissionsContextProvider, {
    value: providerValue
  }, /* @__PURE__ */ react.createElement(Main.Main, null, /* @__PURE__ */ react.createElement(build.SettingsPageTitle, {
    name: "API Tokens"
    ...
    return /* @__PURE__ */ react.createElement(build.Form, null, /* @__PURE__ */ react.createElement(components_FormHead, {
      apiToken,
      setApiToken,
      canEditInputs,
      canRegenerate,
      isSubmitting
    }), /* @__PURE__ */ react.createElement(components_FormBody, {
      apiToken,
      errors,
